...
if [ $USE_SGLANG -eq 1 ]; then
    pip install "sglang[all]==0.4.6.post5" --no-cache-dir --find-links https://flashinfer.ai/whl/cu124/torch2.6/flashinfer-python && pip install "torch-memory-saver>=0.0.5" --no-cache-dir
fi
...
pip install "transformers[hf_xet]==4.51.3" accelerate datasets peft hf-transfer \
    ...
    "ray[default]==2.44.1" codetiming hydra-core pylatexenc qwen-vl-utils wandb dill pybind11 liger-kernel mathruler \
...
# Install flashinfer-0.2.5+cu124 for torch 2.6.
